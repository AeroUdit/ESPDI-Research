...
$$
m_0-\dot{m}*p t_b \geq m*{\mathrm{dry}}.
$$
...
The variable-mass position coefficient is
...
Thus, ESPDI-T analytically determines both the burn interval and the corresponding three-dimensional ignition point.
...
ESPDI-A therefore provides an analytical solution satisfying the imposed terminal-direction construction, but in the tested cases it is not as fuel-efficient as the numerical optimizer.
